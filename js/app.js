...
function createCartItem(product) {
  ...
  APP.elements["pTax"].innerHTML = `Price with tax: $${(result.tax*100).toFixed(2)}%`;
  APP.elements["pTotalPrice"].innerHTML = `Total Price: $${result.total_price.toFixed(2)}`;
    })
    ...
    `
    divCartItem.append(inputQuanttity)
    inputQuanttity.before(btnIncrease)
    btnIncrease.after(btnDecrease)
